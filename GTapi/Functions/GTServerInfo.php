<?php
/*
	* Name: GameTracker.rs API Script - Server Info
	* Author: MBS
	* Version: v1.3

	* Facebook page: https://www.facebook.com/pages/MagicBrush-Software/666346276834469
	...
	switch($type)
	{
		...
		case 'balcan_rank':
			if($data['balcan'] == 1)
				...
				return 'Server is not located on Balcan.';
		break;
		case 'players':
			return $data['players'];
		break;
